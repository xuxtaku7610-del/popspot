...
| 홈 화면 | 팝업 트렌드 |
|---|---|
| <img src="./docs/images/home.png" width="250"/> | <img src="./docs/images/popup-feed.png" width="250"/> |
| 실시간 팝업스토어 소식과 주요 기능을 확인할 수 있는 메인 화면입니다. | 네이버 블로그 검색 API 기반 팝업스토어 게시글 목록 화면입니다. |

| 팝업 지도 | 스크랩 |
|---|---|
| <img src="./docs/images/nearby-map.png" width="250"/> | <img src="./docs/images/scrap-list.png" width="250"/> |
| 네이버 지도에서 주변 팝업스토어 위치와 현재 위치 기준 거리를 확인할 수 있습니다. | 관심 있는 팝업스토어 정보를 저장하고 다시 확인할 수 있는 화면입니다. |

| 마이페이지 |
|---|
| <img src="./docs/images/mypage.png" width="250"/> |
| 사용자 정보, 스크랩 수, 최근 검색, 앱 설정 등을 확인할 수 있는 화면입니다. |
